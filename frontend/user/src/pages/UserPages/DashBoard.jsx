      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight flex items-center gap-2">
            Welcome Back, {userData?.username || 'Malhar'} 👋
          </h1>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {stats.map((stat) => {
              ...
              return (
                <div key={stat.label} className="bg-white border border-slate-100 p-5 rounded-2xl shadow-sm flex flex-col justify-between hover:shadow-md transition duration-200">
          ...
          <div className="grid grid-cols-3 gap-4">
            <button className="bg-white hover:bg-slate-50 transition border border-slate-100 p-5 rounded-2xl shadow-sm flex items-center gap-4 text-left hover:shadow-md transition duration-200">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Focus Card 1 */}
              <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm flex flex-col justify-between border-l-4 border-l-blue-600 hover:shadow-md transition duration-200">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Shipment ID</p>
